        ...
        <div className="grid grid-cols-1 mb-12 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-x-8 gap-y-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li onClick={() => navigate("/careers")} className={linkStyle}>
                Careers
              </li>
              <li onClick={() => navigate("/blog")} className={linkStyle}>
                Blog
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className={linkStyle}>AI Resume Writer</li>
              <li className={linkStyle}>ATS Optimization</li>
              <li className={linkStyle}>Cover Letter Gen</li>
              <li className={linkStyle}>Smart Formatting</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li onClick={() => navigate("/about")} className={linkStyle}>
                About Us
              </li>
              <li
                onClick={() => {
              ...
              <li onClick={() => navigate("/contact")} className={linkStyle}>
                Contact Us
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li onClick={() => navigate("/terms")} className={linkStyle}>
                Terms & Conditions
              </li>
            </ul>
          </div>
