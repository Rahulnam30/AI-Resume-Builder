...
const LivePreview = forwardRef((props, ref) => {
  ...
  useLayoutEffect(() => {
    ...
    const update = () => {
      ...
      setFitZoom(clamp(w / PAGE_WIDTH, ZOOM_MIN, ZOOM_MAX));
    };
    update();
    ...
    <div
      style={{
       ...
       justifyContent: "flex-start",
        gap: 4,
        padding: "0 14px",   // 👈 increase right breathing space
        height: 46,
        background: "#ffffff",
    ...
    >
      ...
      <div
        style={{
          ...
          gap: 7,
          minWidth: 0,
          flex: "0 1 auto",   // 🔥 stop pushing right side out
          overflow: "hidden",
        }}
      >
        <div
...
>
  ...
  onClick={() => {
    ...
    setMoreOpen(false);
          ...
          active={isExpanded || localExpanded}
          title={(isExpanded || localExpanded)
  ? "Exit fullscreen (F)"
  : "Fullscreen (F)"}
        >
    ...
    >
      <div
        style={{
          ...
          overflowY: "auto",
          overflowX: "hidden",
          padding: (isExpanded || localExpanded)
  ? "12px 8px"   // 🔥 minimal padding in fullscreen
  : (isNarrow ? "14px 10px" : "24px 20px"),
          background: showGrid
  ...
  style={{
    display: "flex",
    justifyContent: "center",   // 🔥 center like CV
    width: "100%",
  }}
>
        <PaginatedPreview
  ...
  const inner = (
    ...
    >
      ...
      <div style={{ display: "flex", flex: 1, minHeight: 0 }}>
        {renderCanvas()}
        {!(isExpanded || localExpanded || isMobileView) && renderThumbnailStrip()}
      </div>
    </div>
  );
