export const COVER_LETTER_TEMPLATES = [
    ...
    { id: 'tech', name: 'Tech Template', category: 'Modern', level: 'Tech Level' },
    { id: 'creative', name: 'Creative Template', category: 'Creative', level: 'Creative Level' },
    { id: 'vibrant', name: 'Vibrant Template', category: 'Creative', level: 'Artist Level' },
    { id: 'minimal', name: 'Minimal Template', category: 'Minimal', level: 'Entry Level' },
